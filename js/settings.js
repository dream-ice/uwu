...
function loadSettingsToSidebar() {
    ...
    if (e) {
        ...
        const _tmSel = document.getElementById('setting-time-mode');
        if (_tmSel) _tmSel.value = e.timeMode || 'real';
...
async function saveSettingsFromSidebar() {
    ...
    if (e) {
        ...
        const _tmSelSave = document.getElementById('setting-time-mode');
        if (_tmSelSave) e.timeMode = _tmSelSave.value || 'real';
